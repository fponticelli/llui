...
var $author$project$Main$benchReady = _Platform_outgoingPort(
	'benchReady',
	function ($) {
...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{Y: 0, l: 1, a: _List_Nil, z: -1},
		$author$project$Main$benchReady(0));
};
var $author$project$Main$RunOp = function (a) {
	return {$: 0, a: a};
};
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Main$runOp = _Platform_incomingPort('runOp', $elm$json$Json$Decode$string);
var $author$project$Main$subscriptions = function (_v0) {
	return $author$project$Main$runOp($author$project$Main$RunOp);
};
var $author$project$Main$adjectives = _List_fromArray(
...
var $author$project$Main$nouns = _List_fromArray(
...
var $author$project$Main$buildLabel = function (n) {
	var noun = A2(
		$elm$core$Maybe$withDefault,
		'',
		A2(
			$author$project$Main$listAt,
			A2($elm$core$Basics$modBy, 9, n),
			$author$project$Main$nouns));
	var adj = A2(
		$elm$core$Maybe$withDefault,
		'',
		A2(
			$author$project$Main$listAt,
			A2($elm$core$Basics$modBy, 9, n),
			$author$project$Main$adjectives));
	return adj + (' ' + noun);
};
var $author$project$Main$buildData = F2(
	function (count, startId) {
		var ids = A2($elm$core$List$range, startId, (startId + count) - 1);
		var rows = A2(
			$elm$core$List$map,
			function (id) {
				return {
					k: id,
					D: $author$project$Main$buildLabel(id)
				};
			},
			ids);
		return _Utils_Tuple2(rows, startId + count);
	});
	...
	function (msg, model) {
		switch (msg.$) {
			case 0:
				...
				switch (op) {
					case 'run':
						var _v2 = A2($author$project$Main$buildData, 1000, model.l);
						var rows = _v2.a;
						var nextId = _v2.b;
						return _Utils_Tuple2(
							_Utils_update(
					...
					case 'runlots':
						var _v3 = A2($author$project$Main$buildData, 10000, model.l);
						var rows = _v3.a;
						var nextId = _v3.b;
						return _Utils_Tuple2(
							_Utils_update(
							...
							$elm$core$Platform$Cmd$none);
					case 'add':
						var _v4 = A2($author$project$Main$buildData, 1000, model.l);
						var newRows = _v4.a;
						var nextId = _v4.b;
						return _Utils_Tuple2(
							_Utils_update(
								...
								{
									l: nextId,
									a: _Utils_ap(model.a, newRows)
								}),
							$elm$core$Platform$Cmd$none);
					case 'update':
						var updateRow = F2(
							function (idx, row) {
								return (!A2($elm$core$Basics$modBy, 10, idx)) ? _Utils_update(
									row,
									{D: row.D + ' !!!'}) : row;
							});
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									a: A2($elm$core$List$indexedMap, updateRow, model.a)
								}),
							$elm$core$Platform$Cmd$none);
					case 'clear':
						return _Utils_Tuple2(
					...
					case 'swap':
						var _v5 = _Utils_Tuple2(
							A2($author$project$Main$listAt, 1, model.a),
							A2($author$project$Main$listAt, 998, model.a));
						if ((!_v5.a.$) && (!_v5.b.$)) {
							var r1 = _v5.a.a;
							var r998 = _v5.b.a;
							var swapRow = F2(
								function (idx, row) {
									return (idx === 1) ? r998 : ((idx === 998) ? r1 : row);
								});
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										a: A2($elm$core$List$indexedMap, swapRow, model.a)
									}),
								$elm$core$Platform$Cmd$none);
						} else {
					...
					case 'replace':
						var _v8 = A2($author$project$Main$buildData, 1000, model.l);
						var rows = _v8.a;
						var nextId = _v8.b;
						return _Utils_Tuple2(
							_Utils_update(
							...
							[
								...
								_List_fromArray(
									[
										...
										$author$project$Main$Select(row.k))
									]),
								_List_fromArray(
									[
										$elm$html$Html$text(row.D)
									]))
							])),
						A2(
						$elm$html$Html$td,
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Events$onClick(
										$author$project$Main$Remove(row.k))
									]),
								_List_fromArray(
									[
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2(
					$elm$core$List$map,
					$author$project$Main$viewRow(model.z),
					model.a))
			]));
};
