...
| [`@llui/devmode-annotate-editor`](packages/devmode-annotate-editor) | Optional rich Markdown editor upgrade for the annotation HUD; auto-registered by the Vite plugin when installed                                                        |
...
| [`@llui/lexical-loro`](packages/lexical-loro)                       | Opt-in Loro CRDT binding — `loroCollab`, deterministic convergence, container schema, and independent named text-format marks                                          |
