...
| ----------: | -----------: | -------: | -------: | -------: | -------: | -------: |
|   Create 1k |  **21.3 ms** |  21.2 ms |  21.4 ms |  20.6 ms |  24.3 ms |  29.6 ms |
|  Replace 1k |  **24.7 ms** |  23.7 ms |  24.4 ms |  22.1 ms |  30.0 ms |  30.0 ms |
| Update 10th |  **14.6 ms** |  14.2 ms |  14.3 ms |  12.6 ms |  17.3 ms |  17.5 ms |
|      Select |   **3.2 ms** |   4.0 ms |   6.1 ms |   3.1 ms |   6.2 ms |   5.9 ms |
|        Swap |  **16.8 ms** |  16.3 ms |  16.3 ms |  14.2 ms |  96.4 ms |  18.4 ms |
|      Remove |  **11.9 ms** |  11.1 ms |  11.4 ms |  10.7 ms |  12.5 ms |  13.5 ms |
|  Create 10k | **229.2 ms** | 220.4 ms | 223.6 ms | 206.7 ms | 414.5 ms | 259.8 ms |
|   Append 1k |  **26.4 ms** |  24.7 ms |  24.7 ms |  24.1 ms |  29.4 ms |  30.9 ms |
|       Clear |  **11.5 ms** |  11.8 ms |  11.5 ms |   9.1 ms |  18.1 ms |  13.2 ms |
...
| ----------: | -------: | --------: | ---------: | --------: | -------: |
|   Create 1k |        = |         = |        -3% |  **+14%** | **+39%** |
|  Replace 1k |      -4% |       -1% |       -11% |  **+21%** | **+21%** |
| Update 10th |      -3% |       -2% |       -14% |  **+18%** | **+20%** |
|      Select | **+25%** |  **+91%** |        -3% |  **+94%** | **+84%** |
|        Swap |      -3% |       -3% |       -15% | **+474%** | **+10%** |
|      Remove |      -7% |       -4% |       -10% |   **+5%** | **+13%** |
|  Create 10k |      -4% |       -2% |       -10% |  **+81%** | **+13%** |
|   Append 1k |      -6% |       -6% |        -9% |  **+11%** | **+17%** |
|       Clear |      +3% |         = |       -21% |  **+57%** | **+15%** |
...
|    Run 1k | **2.4 MB** | 2.7 MB | 2.9 MB |  1.9 MB | 4.4 MB | 3.7 MB |
|     Clear | **0.9 MB** | 0.8 MB | 1.0 MB |  0.7 MB | 2.0 MB | 1.0 MB |
