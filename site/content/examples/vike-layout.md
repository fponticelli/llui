...
description: 'Persistent nested layouts with @llui/vike, prerendered to static HTML.'
---

<div class="example-embed">
  <div class="example-embed-bar">
    <span class="example-embed-dots"><i></i><i></i><i></i></span>
    <span class="example-embed-url">/apps/vike-layout/</span>
    <a class="example-embed-open" href="/apps/vike-layout/" target="_blank" rel="noopener">Open ↗</a>
  </div>
  <iframe class="example-embed-frame" src="/apps/vike-layout/" title="Vike Layout (SSR) — live demo" loading="lazy"></iframe>
</div>

<p class="example-source"><a href="https://github.com/fponticelli/llui/tree/main/examples/vike-layout" target="_blank" rel="noopener">View source on GitHub ↗</a></p>
