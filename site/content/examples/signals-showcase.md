...
description: 'Counter, todos, and an editor that exercise the whole signal surface.'
---

<div class="example-embed">
  <div class="example-embed-bar">
    <span class="example-embed-dots"><i></i><i></i><i></i></span>
    <span class="example-embed-url">/apps/signals-showcase/</span>
    <a class="example-embed-open" href="/apps/signals-showcase/" target="_blank" rel="noopener">Open ↗</a>
  </div>
  <iframe class="example-embed-frame" src="/apps/signals-showcase/" title="Signals Showcase — live demo" loading="lazy"></iframe>
</div>

<p class="example-source"><a href="https://github.com/fponticelli/llui/tree/main/examples/signals-showcase" target="_blank" rel="noopener">View source on GitHub ↗</a></p>
