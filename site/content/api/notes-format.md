...
##### `Annotation` from `@llui/notes-format/note-types`
...
##### `Author` from `@llui/notes-format/note-types`

```typescript
export type Author = 'human' | 'llm'
```

##### `CaptureLevel` from `@llui/notes-format/note-types`

```typescript
export type CaptureLevel = 'standard' | 'verbose'
```

##### `LogLevel` from `@llui/notes-format/note-types`

```typescript
export type LogLevel = 'log' | 'warn' | 'error' | 'info' | 'debug'
```

##### `NoteIntent` from `@llui/notes-format/note-types`

```typescript
export type NoteIntent = 'task' | 'note'
```

##### `NoteKind` from `@llui/notes-format/note-types`

```typescript
export type NoteKind = 'rect' | 'element' | 'text' | 'capture' | 'reply'
```

##### `NoteStatus` from `@llui/notes-format/note-types`
...
##### `ReproEvent` from `@llui/notes-format/note-types`
...
##### `ServerEvent` from `@llui/notes-format/note-types`
...
##### `SseRole` from `@llui/notes-format/note-types`
...
##### `AgentSchemaSummary` from `@llui/notes-format/note-types`
...
##### `CaptureRequestPayload` from `@llui/notes-format/note-types`
...
##### `CaptureRequestResponse` from `@llui/notes-format/note-types`
...
##### `ComponentMetaRef` from `@llui/notes-format/note-types`
...
##### `ConsoleLogEntry` from `@llui/notes-format/note-types`
...
##### `CreateNoteRequest` from `@llui/notes-format/note-types`
...
##### `CreateNoteResponse` from `@llui/notes-format/note-types`
...
##### `CurrentSessionResponse` from `@llui/notes-format/note-types`
...
##### `DirtyTraceEntry` from `@llui/notes-format/note-types`
...
##### `ListNotesError` from `@llui/notes-format/note-types`
...
##### `ListNotesQuery` from `@llui/notes-format/note-types`
...
##### `ListNotesResponse` from `@llui/notes-format/note-types`
...
##### `MessageLogEntry` from `@llui/notes-format/note-types`
...
##### `NoteBody` from `@llui/notes-format/note-types`
...
##### `NoteFrontmatter` from `@llui/notes-format/note-types`
...
##### `NoteRect` from `@llui/notes-format/note-types`
...
##### `NoteSummary` from `@llui/notes-format/note-types`
...
##### `PendingEffectEntry` from `@llui/notes-format/note-types`
...
##### `PendingMessage` from `@llui/notes-format/note-types`
...
##### `ProposedDiff` from `@llui/notes-format/note-types`
...
##### `RecentEffectEntry` from `@llui/notes-format/note-types`
...
##### `RuntimeErrorEntry` from `@llui/notes-format/note-types`
...
##### `SourceMapEntry` from `@llui/notes-format/note-types`
...
##### `StatusTransition` from `@llui/notes-format/note-types`
...
##### `StructuralSnapshot` from `@llui/notes-format/note-types`
...
##### `VerboseNoteBody` from `@llui/notes-format/note-types`
...
##### `buildQueue()` from `@llui/notes-format/note-format`
...
##### `currentStatusFromHistory()` from `@llui/notes-format/note-format`
...
##### `defaultSessionName()` from `@llui/notes-format/note-format`
...
##### `deriveFilename()` from `@llui/notes-format/note-format`

```typescript
function deriveFilename(id: string, author: Author, kind: NoteKind, slug: string): string
```

##### `deriveSlug()` from `@llui/notes-format/note-format`
...
##### `padId()` from `@llui/notes-format/note-format`
...
##### `preview()` from `@llui/notes-format/note-format`
...
##### `ParsedFilename` from `@llui/notes-format/note-format`
...
##### `QueueEntry` from `@llui/notes-format/note-format`
...
##### `NOTE_FILENAME_RE` from `@llui/notes-format/note-format`

```typescript
const NOTE_FILENAME_RE
```

##### `NOTE_SCHEMA_VERSION` from `@llui/notes-format/note-format`
...
##### `parseNote()` from `@llui/notes-format/note-serialize`

```typescript
function parseNote(markdown: string): SerializedNote
```

##### `serializeNote()` from `@llui/notes-format/note-serialize`
...
##### `SerializedNote` from `@llui/notes-format/note-serialize`
