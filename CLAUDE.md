...
Eighteen packages under `packages/`, managed by pnpm workspaces + Turborepo:
...
| `@llui/markdown-editor`        | WYSIWYG Markdown editor: `markdownEditor()` component, transformer registry, GFM/callout plugins, toolbar surface      | @llui/lexical, @llui/dom   |
